...
<form name="frmXoa" method="post" action="">
    <p>
        <a href="<?php echo $data["url"] ?>Payment/addView"><img src="https://img.icons8.com/officexs/16/000000/plus.png"> Add new</a>
    </p>
<table id="tablesalomon" class="table table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
        <tr>
                <th><strong>Payments ID</strong></th>
                <th><strong>Payments name</strong></th>
        ...
        <a href="<?php echo $data["url"] ?>Payment/updateView/<?php echo $row['payment_id'] ?>">
        <img src="https://img.icons8.com/officexs/16/000000/edit.png"></a>
        </td>
        
        <td align='center' class='cotNutChucNang'>
        <a onclick="return deleteConfirm()" href="<?php echo $data["url"] ?>/Payment/paymentDelete/<?php echo $row['payment_id'] ?>">
