...
<div class="super_container">
							...
							<div class="header_search_content">
								<div class="header_search_form_container">
									<form action="#" class="header_search_form clearfix">
										...
										<!--<button type="submit" class="header_search_button trans_300" value="Submit"><img src="<?php echo $data["url"] ?>/public/images/search.png" alt=""></button>-->
									</form>
								</div>
							</div>
						</div>
					...
					<div class="col">
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="cat_menu_container" style="background-color: #00BFFF">
								...
								<ul class="cat_menu">
									<?php while($row = mysqli_fetch_array($data["ProductList"], MYSQLI_ASSOC)){ ?>

									<li><a href="<?php echo $data["url"] ?>Home/ProductOfProducer/<?php echo $row['producer_id'] ?>"> <?php echo strtoupper($row["producer_name"])?><i class="fas fa-chevron-right"></i></a></li>
	...
	<div class="banner">
		<div class="banner_background" style="background-image:url('<?php echo $data["url"];?>public/images/Background.jpg')"></div>
		<div class="container fill_height">
			<div class="row fill_height">
				<div class="banner_product_image" ><img width="90%" src="<?php echo $data["url"]; ?>public/images/huawei-p40-40-pro-3.jpg" alt=""></div>
...
<script src="<?php echo $data["url"]; ?>js/jquery-3.3.1.min.js"></script>
...
<!--<script src="<?php echo $data["url"]; ?>js/product_custom.js"></script>-->
